...
'Any'.subclass(function (I) {
  ...
  I.know({
    ...
    $expr: null,
    //@{Rt.Table|[any]} frozen table or array with child values
    _: null,
    //@ Abort with error.
    //@param ... {any} error reasons
    //@return never
    $bad: function () {
    ...
    //@param visit {Rt.Closure} called with child value and index
    ...
    //@param values_ {Rt.Table} updated child values
